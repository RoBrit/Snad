...
public class BlockRegistry {
    ...
    public static final RegistryObject<Block> SUOL_SNAD = BLOCKS.register(References.ID_BLOCK_SUOL_SNAD, () -> new SuolSnadBlock(BlockBehaviour.Properties.of(Material.SAND, MaterialColor.COLOR_BROWN).randomTicks().strength(0.5F).speedFactor((float) Snad.config().getMovementSpeed()).sound(SoundType.SOUL_SAND)));
